                ...
                <form method="post">
                    ...
                    <div class="row control-group">
                        <div class="form-group col-xs-12">
                            ...
                            <input type="text" class="form-control" placeholder="isi NIS" id="nis" name="nis" required data-validation-required-message="harap di isi">
                    ...
                    <div class="row control-group">
                        <div class="form-group col-xs-12">
                            ...
                            <input type="text" class="form-control" placeholder="isi nama siswa" id="nama" name="nama" required data-validation-required-message="harap di isi">
                            <p class="help-block text-danger"></p>
                        </div>
                    </div>                        
                    <div class="row control-group">
                        <div class="form-group col-xs-12 ">
                            ...
                            <input type="text" class="form-control" placeholder="isi umur siswa" id="umur" name="umur" required data-validation-required-message="harap di isi">
                            <p class="help-block text-danger"></p>
                        </div>
                    </div>
                   <div class="row control-group">
                        <div class="form-group col-xs-12">
                            ...
                            <textarea rows="5" class="form-control" placeholder="isi alamat siswa" id="alamat" name="alamat" required data-validation-required-message="harap di isi"></textarea>
                            <p class="help-block text-danger"></p>
                        </div>
                    </div>
                    <div class="row control-group">
